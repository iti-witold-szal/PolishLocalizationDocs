...
>[!NOTE]
>Istotne będzie, czy rachunek znajdował się w wykazie w dniu
...
2.  W oknie **Kartoteka ustawień wykazu podatników VAT**, które się
    ...
    >[!NOTE]
    >W przypadku wybrania opcji **Plik i API**, system będzie
...
>[!NOTE]
>Według specyfikacji Ministerstwa Finansów, dostęp do API
jest limitowany. Zalecane jest więc korzystanie z pliku i ograniczenie
wykorzystania API do minimum.

>[!NOTE]
>W związku z techniczną naturą ustawień, dostęp do nich
...
>[!NOTE]
>Jeśli wcześniej pobrane były dane kontrahenta z BIR lub pola
...
>[!NOTE]
>Jeśli akcja **Aktualizuj kartotekę dostawcy** zostanie
...
>[!NOTE]
>Jeśli krok 5. zostanie pominięty, czyli w oknie **Lista kont
